...
function duplicate({ value, init, rename = name => name }) {
    var _a, _b, _c;
    const c_clone_transformer = new traversal_1.JsonTransformerTraversal(), c_init = init, c_value = ((_a = value[rename(VALUE)]) !== null && _a !== void 0 ? _a : null), c_times = ((_b = value[rename(TIMES)]) !== null && _b !== void 0 ? _b : c_init.times), c_flatten = ((_c = value[rename(FLATTEN)]) !== null && _c !== void 0 ? _c : c_init.flatten), c_result = [];

...
class JsonTransformerFunction extends transformer_1.JsonTransformer {
    constructor(_ = {}) {
        var _a;
        super(_);
        this.a_functions = { [interfaces_1.JsonType.Array]: {},
        ...
        this.transformerJsonArray = (_) => {
            ...
            const f = this.a_functions[interfaces_1.JsonType.Array][_.value[0]];
        ...
        this.transformerJsonObject = (_) => {
            ...
            if (typeof c_function_name === 'string' && _.value[c_function_name] != null) {
                const f = this.a_functions[interfaces_1.JsonType.Object][c_function_name];
                return f == null ? _.value : f(_);
            }
            else {
                return _.value;
        ...
        this.transformerJsonString = (_) => {
            const f = this.a_functions[interfaces_1.JsonType.String][_.value];
            return f == null ? _.value : f(_);
        };
